...
- [ ] Mission 9 - AOP 로깅 (실행 시간/입출력 자동 로깅, MDC 추적 ID)
- [ ] Mission 10 - 예외 처리 (@ControllerAdvice, 커스텀 예외 계층)
- [ ] Mission 11 - 페이징 + 검색 (Pageable, 채널/상태/날짜 필터링)
- [ ] Mission 12 - REST API 분리 (/api/v1, Swagger)
- [ ] Mission 13 - Actuator + 커스텀 메트릭 (Micrometer)
- [ ] Mission 14 - Prometheus + Grafana (모니터링 대시보드)
- [ ] Mission 15 - DLQ + 실패 관리 (RabbitMQ Dead Letter Queue)
- [ ] Mission 16 - 테스트 강화 (Testcontainers 통합 테스트)
